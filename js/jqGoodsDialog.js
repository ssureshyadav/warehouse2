(function( $ ){ //регистрация плагина
	...
	init: function(/*Settings*/ s ){	
		var sett=$.extend({
				...
				,urlGROUP: 	 "json.GoodsGroup2.cls" //адрес с которого забираем данные по дереву групп
				,urlGOOD:  	 "json.Goods.cls" //адрес с данными по товарам
				...
				,tName:		 'Наименование'
				,tCatLabel:  'Каталог'
				,tCatButton: 'Выбор каталога'
				,tCatClmn:   'Наименование'
				,tCatDlg:    'Выбор каталога'
				,tGrpGrd: 	 'Группы товаров'
				,tGrpCollapse: 'Свернуть'
				,tGrpExpand: 'Развернуть'
				,tGdGrd:  'Товары'
				,tWarnTtl: 'Внимание!'
				,tWarnMsg: 	'Пожалуйста, выберите товар!'
			}
			, s
		);
