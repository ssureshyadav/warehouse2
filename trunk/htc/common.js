...
window.showModalDialog("showgoodsimages.csp?GoodsId="+tovid,"","cener:yes;status:no;dialogHeight:600px;dialogWidth:600px;resizable:yes;")
}
...
{
  document.cookie = sName + "=" + sValue + "; expires=Fri, 31 Dec 2010 23:59:59 GMT;";
 }
...
RootNode.appendChild(AllHeaders);
}