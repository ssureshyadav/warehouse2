(function(c){var l=JSON?function(a){return JSON.stringify(a)}:function(a){return c.obj2json(a)},k=function(a,b){var d=l(b);c.cookie(a,d)},j=function(a){a=c.cookie(a);return c.parseJSON(a)||{}},m=function(a,b){c(a).jqGrid("navButtonAdd",b,{id:"bSetColumns",caption:"",title:"\u041f\u043e\u043a\u0430\u0437\u0430\u0442\u044c/\u0421\u043a\u0440\u044b\u0442\u044c \u043a\u043e\u043b\u043e\u043d\u043a\u0438",buttonicon:"ui-icon-newwin",onClickButton:function(){c(a).setColumns({width:350,colnameview:false});
